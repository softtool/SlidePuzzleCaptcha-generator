...
if __name__ == "__main__":
    # 定义图片目录和输出文件路径
    #image_directory = os.path.abspath(os.path.join(__file__, '..', '..', '..', '..', 'images', 'slider', 'ImageCaptcha'))

    #labels_output = os.path.join(image_directory, 'labels.txt')

    image_directory =r"C:\bigmodel\dddd\dddd_trainer\images_set\images"
    labels_output =r"C:\bigmodel\dddd\dddd_trainer\images_set\images\labels.txt"
    # 调用函数生成 labels.txt
